const kelimeHavuzu = [
  ...
  { en: "Abandon", tr: "Terk etmek", level: "B2" },
  { en: "Absolute", tr: "Tam, mutlak", level: "B2" },
  { en: "Academic", tr: "Akademik", level: "B2" },
  { en: "Acceptable", tr: "Kabul edilebilir", level: "B2" },
  { en: "Accompany", tr: "Eşlik etmek", level: "B2" },
  { en: "Accurate", tr: "Doğru, kesin", level: "B2" },
  { en: "Accuse", tr: "Suçlamak, itham etmek", level: "B2" },
  { en: "Acknowledge", tr: "Kabul etmek", level: "B2" },
  { en: "Acquire", tr: "Elde etmek, edinmek", level: "B2" },
  { en: "Actual", tr: "Aktüel, gerçek", level: "B2" },
  { en: "Adapt", tr: "Adapte etmek, uyarlamak", level: "B2" },
  { en: "Additional", tr: "Fazladan, ek, ilave", level: "B2" },
  { en: "Address", tr: "Konuşma yapmak, söylev vermek", level: "B2" },
  { en: "Administration", tr: "İdare, yönetim", level: "B2" },
  { en: "Adopt", tr: "Evlat edinmek, benimsemek", level: "B2" },
  { en: "Advance", tr: "Terfi, avans, ilerleme, geliştirmek", level: "B2" },
  { en: "Affair", tr: "Mesele, şey, iş", level: "B2" },
  { en: "Afterwards", tr: "Sonradan, sonra", level: "B2" },
  { en: "Agency", tr: "Acente, ajans", level: "B2" },
  { en: "Agenda", tr: "Gündem, ajanda", level: "B2" },
  { en: "Aggressive", tr: "Agresif", level: "B2" },
  { en: "Aid", tr: "İane, yardım, yardım etmek", level: "B2" },
  { en: "Aircraft", tr: "Uçak", level: "B2" },
  { en: "Alarm", tr: "Birini endişelendirmek, korkutmak", level: "B2" },
  { en: "Alter", tr: "Değiştirmek", level: "B2" },
  { en: "Amount", tr: "Tutmak, eşdeğer olmak", level: "B2" },
  { en: "Anger", tr: "Hiddet, sinir, öfke", level: "B2" },
  { en: "Angle", tr: "Açı, bakış açısı", level: "B2" },
  { en: "Anniversary", tr: "Yıl dönümü", level: "B2" },
  { en: "Annual", tr: "Yıllık", level: "B2" },
  { en: "Anxious", tr: "Endişeli, kaygılı", level: "B2" },
  { en: "Apparent", tr: "Aşikâr, ortada, belirgin", level: "B2" },
  { en: "Apparently", tr: "Görünüşe göre", level: "B2" },
  { en: "Appeal", tr: "Ricada bulunma, çekicilik, talep etmek", level: "B2" },
  { en: "Approach", tr: "Yaklaşım, yaklaşmak", level: "B2" },
  { en: "Appropriate", tr: "Münasip, uygun", level: "B2" },
  { en: "Approval", tr: "Tasvip, onaylama", level: "B2" },
  { en: "Approve", tr: "Onaylamak, izin vermek", level: "B2" },
  { en: "Arise", tr: "Ortaya çıkmak, zuhur etmek", level: "B2" },
  { en: "Armed", tr: "Silahlı", level: "B2" },
  { en: "Arms", tr: "Arma, silahlar", level: "B2" },
  { en: "Artificial", tr: "Yapay, samimi olmayan", level: "B2" },
  { en: "Artistic", tr: "Artistik", level: "B2" },
  { en: "Ashamed", tr: "Mahcup, utanmış", level: "B2" },
  { en: "Aspect", tr: "Hal, taraf, yön", level: "B2" },
  { en: "Assess", tr: "Değerlendirmek", level: "B2" },
  { en: "Assessment", tr: "Değerlendirme", level: "B2" },
  { en: "Associate", tr: "İlişkilendirmek, bağdaştırmak", level: "B2" },
  { en: "Associated", tr: "Bağlantılı, ilişkili", level: "B2" },
  { en: "Association", tr: "Dernek, cemiyet, ortaklık", level: "B2" },
  { en: "Assume", tr: "Varsaymak", level: "B2" },
  { en: "Attempt", tr: "Teşebbüs, teşebbüs etmek", level: "B2" },
  { en: "Back", tr: "Desteklemek, yardım etmek", level: "B2" },
  { en: "Bacteria", tr: "Bakteri", level: "B2" },
  { en: "Bar", tr: "Engel olmak", level: "B2" },
  { en: "Barrier", tr: "Bariyer", level: "B2" },
  { en: "Basically", tr: "Esasen, aslında, temel olarak", level: "B2" },
  { en: "Battle", tr: "Mücadele etmek", level: "B2" },
  { en: "Beat", tr: "Kalp atışı, ritim", level: "B2" },
  { en: "Beg", tr: "Yalvarmak", level: "B2" },
  { en: "Bent", tr: "Eğilmiş, bükülmüş", level: "B2" },
  { en: "Bet", tr: "Bahse girmek, bahis iddia", level: "B2" },
  { en: "Beyond", tr: "Ötesinde, öte tarafında", level: "B2" },
  { en: "Bill", tr: "Faturalandırmak", level: "B2" },
  { en: "Bitter", tr: "Kızgın, içerlemiş", level: "B2" },
  { en: "Blame", tr: "Suçlamak, suç, kabahat", level: "B2" },
  { en: "Bond", tr: "Bağ, ilişki", level: "B2" },
  { en: "Border", tr: "Çizgi çekmek, sınır çizmek", level: "B2" },
  { en: "Brief", tr: "Kısa, öz", level: "B2" },
  { en: "Broad", tr: "Geniş", level: "B2" },
  { en: "Broadcast", tr: "Yayın yapmak, TV yayını", level: "B2" },
  { en: "Budget", tr: "Bütçe", level: "B2" },
  { en: "Bullet", tr: "Mermi, kurşun", level: "B2" },
  { en: "Bunch", tr: "Topluluk, grup", level: "B2" },
  { en: "Burn", tr: "Yanma, yanık", level: "B2" },
  { en: "Bush", tr: "Çalı", level: "B2" },
  { en: "Cable", tr: "Telefon-elektrik kablosu", level: "B2" },
  { en: "Calculate", tr: "Hesaplamak", level: "B2" },
  { en: "Cancel", tr: "İptal etmek, damgalamak", level: "B2" },
  { en: "Cancer", tr: "Kanser (Allah muhafaza)", level: "B2" },
  { en: "Capable", tr: "Yeterli, güçlü, muktedir", level: "B2" },
  { en: "Capacity", tr: "Kapasite", level: "B2" },
  { en: "Capture", tr: "Ele geçirmek, esir etmek", level: "B2" },
  { en: "Cast", tr: "Oyuncu seçimi yapmak, fırlatmak", level: "B2" },
  { en: "Catch", tr: "Yakalama, bit yeniği, av", level: "B2" },
  { en: "Cell", tr: "Hücre", level: "B2" },
  { en: "Chain", tr: "Peş peşe olanlar, zincirlemek", level: "B2" },
  { en: "Chair", tr: "Oturumu yönetmek", level: "B2" },
  { en: "Chairman", tr: "Başkan, reis", level: "B2" },
  { en: "Challenge", tr: "Zora sokmak, meydan okumak", level: "B2" },
  { en: "Characteristic", tr: "Karakteristik", level: "B2" },
  { en: "Chart", tr: "Kaydetmek, harita yapmak", level: "B2" },
  { en: "Chief", tr: "Başlıca, en önemli, şef, başkan", level: "B2" },
  { en: "Circumstance", tr: "Koşul, durum, vaziyet", level: "B2" },
  { en: "Cite", tr: "Bahsetmek, değinmek", level: "B2" },
  { en: "Citizen", tr: "Vatandaş, sakin, yerli", level: "B2" },
  { en: "Civil", tr: "Sivillere ilişkin", level: "B2" },
  { en: "Classic", tr: "Klasik", level: "B2" },
  { en: "Closely", tr: "Yakından, dikkatlice", level: "B2" },
  { en: "Collapse", tr: "Çökmek, yıkılmak", level: "B2" },
  { en: "Combination", tr: "Birleşim, karışım", level: "B2" },
  { en: "Comfort", tr: "Rahatlık, rahatlatmak", level: "B2" },
  { en: "Command", tr: "Emir, buyruk, komuta etmek", level: "B2" },
  { en: "Commission", tr: "Komisyon, görevlendirmek", level: "B2" },
  { en: "Commitment", tr: "Sadakat, bağlılık", level: "B2" },
  { en: "Committee", tr: "Komite", level: "B2" },
  { en: "Commonly", tr: "Genellikle", level: "B2" },
  { en: "Complex", tr: "Kompleks", level: "B2" },
  { en: "Complicated", tr: "Karmaşık, zor", level: "B2" },
  { en: "Component", tr: "Parça, unsur", level: "B2" },
  { en: "Concentration", tr: "Konsantrasyon", level: "B2" },
  { en: "Concept", tr: "Fikir, kavram, konsept", level: "B2" },
  { en: "Concern", tr: "Endişe, endişelenmek", level: "B2" },
  { en: "Concerned", tr: "Tedirgin", level: "B2" },
  { en: "Conduct", tr: "Davranış, tutum, düzenlemek", level: "B2" },
  { en: "Confidence", tr: "Güven, itimat", level: "B2" },
  { en: "Conflict", tr: "Anlaşmazlık, çatışmak", level: "B2" },
  { en: "Confusing", tr: "Yanıltıcı, karmaşık", level: "B2" },
  { en: "Conscious", tr: "Bilinçli, şuurlu", level: "B2" },
  { en: "Conservative", tr: "Muhafazakâr", level: "B2" },
  { en: "Consideration", tr: "Enine boyuna düşünme", level: "B2" },
  { en: "Consistent", tr: "Tutarlı, istikrarlı", level: "B2" },
  { en: "Constant", tr: "Sürekli, devamlı", level: "B2" },
  { en: "Constantly", tr: "Sürekli olarak", level: "B2" },
  { en: "Construct", tr: "İnşa etmek, yapmak", level: "B2" },
  { en: "Construction", tr: "İnşa etme, yapma", level: "B2" },
  { en: "Contemporary", tr: "Çağdaş, modern", level: "B2" },
  { en: "Contest", tr: "Yarışma, yarışmak, itiraz etmek", level: "B2" },
  { en: "Contract", tr: "Sözleşme, sözleşmek", level: "B2" },
  { en: "Contribute", tr: "Katkı sağlamak", level: "B2" },
  { en: "Contribution", tr: "Katkı", level: "B2" },
  { en: "Convert", tr: "Değiştirmek, dinini değiştirmek", level: "B2" },
  { en: "Convinced", tr: "Emin, inanmış", level: "B2" },
  { en: "Core", tr: "Esas, öz", level: "B2" },
  { en: "Corporate", tr: "Şirkete ait, kurumsal", level: "B2" },
  { en: "Council", tr: "Konsül", level: "B2" },
  { en: "County", tr: "İdari bölge", level: "B2" },
  { en: "Courage", tr: "Cesaret", level: "B2" },
  { en: "Crash", tr: "Çökme, iflas, kaza yapmak", level: "B2" },
  { en: "Creation", tr: "Yaratmak", level: "B2" },
  { en: "Creature", tr: "Yaratık", level: "B2" },
  { en: "Credit", tr: "Hesaba para yatırmak, inanmak", level: "B2" },
  { en: "Crew", tr: "Mürettebat, ekip", level: "B2" },
  { en: "Crisis", tr: "Kriz", level: "B2" },
  { en: "Criterion", tr: "Kriter", level: "B2" },
  { en: "Critic", tr: "Kritik", level: "B2" },
  { en: "Critical", tr: "Eleştirel, can alıcı, tehlikeli", level: "B2" },
  { en: "Criticism", tr: "Eleştiri", level: "B2" },
  { en: "Criticize", tr: "Eleştirmek", level: "B2" },
  { en: "Crop", tr: "Ürün", level: "B2" },
  { en: "Crucial", tr: "Kritik, çok önemli", level: "B2" },
  { en: "Cry", tr: "Bağırma, ağlama, ötme", level: "B2" },
  { en: "Cure", tr: "Tedavi, tedavi etmek", level: "B2" },
  { en: "Current", tr: "Geçerli", level: "B2" },
  { en: "Curve", tr: "Eğri, eğilmek", level: "B2" },
  { en: "Curved", tr: "Eğri", level: "B2" },
  { en: "Date", tr: "Biriyle çıkmak, tarih atmak", level: "B2" },
  { en: "Debate", tr: "Tartışma, tartışmak", level: "B2" },
  { en: "Debt", tr: "Borç", level: "B2" },
  { en: "Decent", tr: "Tatmin edici, doğru, dürüst", level: "B2" },
  { en: "Declare", tr: "Deklare etmek", level: "B2" },
  { en: "Decline", tr: "Düşüş, düşmek", level: "B2" },
  { en: "Decoration", tr: "Dekorasyon", level: "B2" },
  { en: "Decrease", tr: "Artış, artmak", level: "B2" },
  { en: "Deeply", tr: "Çok", level: "B2" },
  { en: "Defeat", tr: "Galip gelmek, yenilgi", level: "B2" },
  { en: "Defence", tr: "Savunma, koruma", level: "B2" },
  { en: "Defend", tr: "Savunmak", level: "B2" },
  { en: "Delay", tr: "Erteleme, ertelemek", level: "B2" },
  { en: "Deliberate", tr: "Kasıtlı", level: "B2" },
  { en: "Deliberately", tr: "Kasıtlı olarak", level: "B2" },
  { en: "Delight", tr: "Sevinç, neşe, keyiflendirmek", level: "B2" },
  { en: "Delighted", tr: "Memnun, sevinçli", level: "B2" },
  { en: "Delivery", tr: "Dağıtım, doğum", level: "B2" },
  { en: "Demand", tr: "Talep, talep etmek", level: "B2" },
  { en: "Demonstrate", tr: "Göstermek", level: "B2" },
  { en: "Deny", tr: "Reddetmek", level: "B2" },
  { en: "Depressed", tr: "Canı sıkkın, bunalımlı", level: "B2" },
  { en: "Depressing", tr: "Kasvetli, iç karartıcı", level: "B2" },
  { en: "Depth", tr: "Derin", level: "B2" },
  { en: "Desert", tr: "Terk etmek", level: "B2" },
  { en: "Deserve", tr: "Hak etmek", level: "B2" },
  { en: "Desire", tr: "İstek, istemek", level: "B2" },
  { en: "Desperate", tr: "Çaresiz, her şeyi göze almış", level: "B2" },
  { en: "Detail", tr: "Ayrıntıyla anlatmak", level: "B2" },
  { en: "Detailed", tr: "Detaylı", level: "B2" },
  { en: "Detect", tr: "Keşfetmek", level: "B2" },
  { en: "Dig", tr: "Kazmak", level: "B2" },
  { en: "Disc", tr: "Disk", level: "B2" },
  { en: "Discipline", tr: "Disiplin", level: "B2" },
  { en: "Discount", tr: "İndirmek, indirip yapmak", level: "B2" },
  { en: "Dishonest", tr: "Sahtekâr, yalancı", level: "B2" },
  { en: "Dismiss", tr: "Kovmak", level: "B2" },
  { en: "Display", tr: "Sergi, sergilemek", level: "B2" },
  { en: "Distribute", tr: "Dağıtmak", level: "B2" },
  { en: "Distribution", tr: "Dağıtım", level: "B2" },
  { en: "District", tr: "Bölge", level: "B2" },
  { en: "Division", tr: "Paylaşma, bölüşme, bölüm", level: "B2" },
  { en: "Domestic", tr: "Evle alakalı, ülke içi", level: "B2" },
  { en: "Dominate", tr: "Egemen olmak, hâkim olmak", level: "B2" },
  { en: "Downwards", tr: "Aşağı doğru", level: "B2" },
  { en: "Dozen", tr: "Düzine", level: "B2" },
  { en: "Draft", tr: "Taslak, taslak hazırlamak", level: "B2" },
  { en: "Drag", tr: "Sürüklemek (birini)", level: "B2" },
  { en: "Dramatic", tr: "Dramatik", level: "B2" },
  { en: "Edit", tr: "Editlemek", level: "B2" },
  { en: "Edition", tr: "Baskı, bölüm", level: "B2" },
  { en: "Efficient", tr: "Verimli, üretken", level: "B2" },
  { en: "Elderly", tr: "Yaşlı", level: "B2" },
  { en: "Elect", tr: "Seçmek", level: "B2" },
  { en: "Elsewhere", tr: "Başka yerde", level: "B2" },
  { en: "Emerge", tr: "Görünmek, belirmek, ortaya çıkmak", level: "B2" },
  { en: "Emotional", tr: "Hisli, duygulu", level: "B2" },
  { en: "Emphasis", tr: "Önem, ehemmiyet, vurgu", level: "B2" },
  { en: "Emphasize", tr: "Vurgulamak", level: "B2" },
  { en: "Enable", tr: "Mümkün kılmak", level: "B2" },
  { en: "Encounter", tr: "Tecrübe etmek, ansızın karşılaşmak", level: "B2" },
  { en: "Engage", tr: "İlgilendirmek, meşgul etmek", level: "B2" },
  { en: "Enhance", tr: "Geliştirmek, katkıda bulunmak", level: "B2" },
  { en: "Enquiry", tr: "Soru, soruşturma", level: "B2" },
  { en: "Ensure", tr: "Temin etmek, garantiye almak", level: "B2" },
  { en: "Enthusiasm", tr: "Coşku, heyecan", level: "B2" },
  { en: "Enthusiastic", tr: "Coşkulu", level: "B2" },
  { en: "Entire", tr: "Tüm, bütün", level: "B2" },
  { en: "Entirely", tr: "Bütünüyle, tamamıyla", level: "B2" },
  { en: "Equal", tr: "Eşit, aynı", level: "B2" },
  { en: "Establish", tr: "Kurmak", level: "B2" },
  { en: "Estate", tr: "Varlık", level: "B2" },
  { en: "Estimate", tr: "Tahmin, tahmin etmek", level: "B2" },
  { en: "Ethical", tr: "Etik", level: "B2" },
  { en: "Evaluate", tr: "Değerlendirmek", level: "B2" },
  { en: "Even", tr: "Düz, engebesiz", level: "B2" },
  { en: "Evil", tr: "Kötü, canavar", level: "B2" },
  { en: "Examination", tr: "İnceleme, tetkik", level: "B2" },
  { en: "Excuse", tr: "Affetmek, bağışlamak, mazeret", level: "B2" },
  { en: "Executive", tr: "Yönetim, icra", level: "B2" },
  { en: "Existence", tr: "Varlık, var oluş", level: "B2" },
  { en: "Expectation", tr: "Umut", level: "B2" },
  { en: "Expense", tr: "Masraf", level: "B2" },
  { en: "Exploration", tr: "Keşif", level: "B2" },
  { en: "Expose", tr: "Maruz kalmak", level: "B2" },
  { en: "Extend", tr: "Uzatmak", level: "B2" },
  { en: "Extent", tr: "Ölçü, derece", level: "B2" },
  { en: "External", tr: "Harici, dış", level: "B2" },
  { en: "Extraordinary", tr: "Olağan dışı, garip", level: "B2" },
  { en: "Extreme", tr: "Aşırı", level: "B2" },
  { en: "Facility", tr: "Tesis, bina", level: "B2" },
  { en: "Failure", tr: "Başarısızlık", level: "B2" },
  { en: "Faith", tr: "İnanç", level: "B2" },
  { en: "Fault", tr: "Hata", level: "B2" },
  { en: "Favour", tr: "Beğenmek, kayırmak", level: "B2" },
  { en: "Feather", tr: "Tüy", level: "B2" },
  { en: "Fee", tr: "Ücret", level: "B2" },
  { en: "Feed", tr: "Besin, yiyecek", level: "B2" },
  { en: "Feedback", tr: "Geri bildirim", level: "B2" },
  { en: "Feel", tr: "His, duygu", level: "B2" },
  { en: "Fellow", tr: "Hemşeri, arkadaş", level: "B2" },
  { en: "Figure", tr: "Bir şeyin parçası olmak, hesaplamak", level: "B2" },
  { en: "File", tr: "Dosyalamak", level: "B2" },
  { en: "Finance", tr: "Maliye, parasal kaynak sağlamak", level: "B2" },
  { en: "Finding", tr: "Bulgu, sonuç", level: "B2" },
  { en: "Firm", tr: "Şirket, firma", level: "B2" },
  { en: "Fix", tr: "Çıkmaz, zorluk", level: "B2" },
  { en: "Flame", tr: "Alev", level: "B2" },
  { en: "Flash", tr: "Parıltı, parıldamak", level: "B2" },
  { en: "Flexible", tr: "Esnek", level: "B2" },
  { en: "Float", tr: "Yüzmek", level: "B2" },
  { en: "Fold", tr: "Kat, kıvrım", level: "B2" },
  { en: "Folding", tr: "Katlanabilir", level: "B2" },
  { en: "Following", tr: "Sonrasında, sonucunda", level: "B2" },
  { en: "Forgive", tr: "Bağışlamak", level: "B2" },
  { en: "Former", tr: "Önceki", level: "B2" },
  { en: "Fortune", tr: "Kader, şans", level: "B2" },
  { en: "Forward", tr: "İleri", level: "B2" },
  { en: "Found", tr: "Bulmak", level: "B2" },
  { en: "Free", tr: "Özgürleştirmek", level: "B2" },
  { en: "Freedom", tr: "Özgürlük", level: "B2" },
  { en: "Frequency", tr: "Sıklık", level: "B2" },
  { en: "Fuel", tr: "Yakıt sağlamak, desteklemek", level: "B2" },
  { en: "Fully", tr: "Tamamıyla, iyice", level: "B2" },
  { en: "Function", tr: "Çalışmak, işlemek", level: "B2" },
  { en: "Fund", tr: "Fon, kaynak, kaynak sağlamak", level: "B2" },
  { en: "Fundamental", tr: "Temel, asıl, esas", level: "B2" },
  { en: "Funding", tr: "Fon, kaynak oluşturma", level: "B2" },
  { en: "Furthermore", tr: "Dahası, ayrıca", level: "B2" },
  { en: "Gain", tr: "Artmak, çoğalmak, elde etmek", level: "B2" },
  { en: "Gang", tr: "Çete, şebeke", level: "B2" },
  { en: "Generate", tr: "Ortaya çıkarmak, oluşturmak", level: "B2" },
  { en: "Genre", tr: "Çeşit, tarz", level: "B2" },
  { en: "Govern", tr: "Yönetmek", level: "B2" },
  { en: "Grab", tr: "Tutmak, atlamak, kaçırmamak", level: "B2" },
  { en: "Grade", tr: "Seviyelere ayırmak, değerlendirmek", level: "B2" },
  { en: "Gradually", tr: "Azar azar, zamanla", level: "B2" },
  { en: "Grand", tr: "Görkemli", level: "B2" },
  { en: "Grant", tr: "Vermek, tahsis etmek, ödenek", level: "B2" },
  { en: "Guarantee", tr: "Garanti, güvence vermek", level: "B2" },
  { en: "Handle", tr: "Başa çıkmak, dokunmak", level: "B2" },
  { en: "Harm", tr: "Zarar, zarar vermek", level: "B2" },
  { en: "Harmful", tr: "Zararlı", level: "B2" },
  { en: "Hearing", tr: "İşitme, duruşma", level: "B2" },
  { en: "Heaven", tr: "Cennet", level: "B2" },
  { en: "Heel", tr: "Ayak topuğu", level: "B2" },
  { en: "Hell", tr: "Cehennem", level: "B2" },
  { en: "Hesitate", tr: "Tereddüt etmek", level: "B2" },
  { en: "High", tr: "Zirve, tepe, heyecan", level: "B2" },
  { en: "Hire", tr: "Kira", level: "B2" },
  { en: "Hold", tr: "Tutma, tutuş", level: "B2" },
  { en: "Hollow", tr: "Kovuk, oyuk", level: "B2" },
  { en: "Holy", tr: "Kutsal", level: "B2" },
  { en: "Honour", tr: "Şeref, haysiyet, onur", level: "B2" },
  { en: "Host", tr: "Ev sahipliği yapmak", level: "B2" },
  { en: "House", tr: "Barındırmak", level: "B2" },
  { en: "Household", tr: "Hane halkı", level: "B2" },
  { en: "Housing", tr: "Mesken, yerleşim", level: "B2" },
  { en: "Humorous", tr: "Komik, gülünç", level: "B2" },
  { en: "Humour", tr: "Espri, mizah", level: "B2" },
  { en: "Hunt", tr: "Arama, av", level: "B2" },
  { en: "Hunting", tr: "Avlanma", level: "B2" },
  { en: "Hurt", tr: "İncitme", level: "B2" },
  { en: "Ideal", tr: "İdeal", level: "B2" },
  { en: "Illustrate", tr: "Resimlemek, örneklerle anlatmak", level: "B2" },
  { en: "Illustration", tr: "Resim", level: "B2" },
  { en: "Imagination", tr: "Hayal, zihin", level: "B2" },
  { en: "Impatient", tr: "Tahammülsüz, sabırsız", level: "B2" },
  { en: "Imply", tr: "Uygulamak", level: "B2" },
  { en: "Impose", tr: "Uygulamak, zorlamak", level: "B2" },
  { en: "Impress", tr: "Vurgulamak", level: "B2" },
  { en: "Impressed", tr: "Etkilenmiş", level: "B2" },
  { en: "Inch", tr: "İnç", level: "B2" },
  { en: "Incident", tr: "Olay, vaka", level: "B2" },
  { en: "Income", tr: "Gelir", level: "B2" },
  { en: "Increasingly", tr: "Artarak", level: "B2" },
  { en: "Industrial", tr: "Endüstriyel", level: "B2" },
  { en: "Infection", tr: "Enfeksiyon", level: "B2" },
  { en: "Inform", tr: "Haber vermek, bildirmek", level: "B2" },
  { en: "Initial", tr: "İlk, başta olan", level: "B2" },
  { en: "Initially", tr: "İlk başta, ilkin", level: "B2" },
  { en: "Initiative", tr: "Girişim, teşebbüs", level: "B2" },
  { en: "Inner", tr: "İç, dahili", level: "B2" },
  { en: "Insight", tr: "Anlayış, kavrayış", level: "B2" },
  { en: "Insist", tr: "Israr etmek", level: "B2" },
  { en: "Inspire", tr: "Teşvik etmek", level: "B2" },
  { en: "Install", tr: "Kurmak, tesis etmek", level: "B2" },
  { en: "Instance", tr: "Örnek", level: "B2" },
  { en: "Institute", tr: "Enstitü", level: "B2" },
  { en: "Institution", tr: "Kurum, kuruluş", level: "B2" },
  { en: "Insurance", tr: "Sigorta", level: "B2" },
  { en: "Intended", tr: "Planlanan, istenilen", level: "B2" },
  { en: "Intense", tr: "Yoğun", level: "B2" },
  { en: "Internal", tr: "İç, dahili", level: "B2" },
  { en: "Interpret", tr: "Yorumlamak", level: "B2" },
  { en: "Interrupt", tr: "Konuşmayı kesmek", level: "B2" },
  { en: "Investigation", tr: "Soruşturma", level: "B2" },
  { en: "Investment", tr: "Yatırım", level: "B2" },
  { en: "Issue", tr: "Resmen bildirmek, söylemek", level: "B2" },
  { en: "Joy", tr: "Sevinç, mutluluk", level: "B2" },
  { en: "Judgement", tr: "Yargı, hüküm", level: "B2" },
  { en: "Junior", tr: "Düşük rütbeli, genç", level: "B2" },
  { en: "Justice", tr: "Adalet", level: "B2" },
  { en: "Justify", tr: "Haklı göstermek", level: "B2" },
  { en: "Labour", tr: "Çalışma, işçiler, doğum", level: "B2" },
  { en: "Landscape", tr: "Manzara", level: "B2" },
  { en: "Largely", tr: "Çoğunlukla", level: "B2" },
  { en: "Latest", tr: "Son, en son", level: "B2" },
  { en: "Launch", tr: "Suya indirmek, uzaya fırlatmak, piyasaya sürmek", level: "B2" },
  { en: "Leadership", tr: "Liderlik", level: "B2" },
  { en: "League", tr: "Lig", level: "B2" },
  { en: "Lean", tr: "Eğilmek", level: "B2" },
  { en: "Leave", tr: "İzin, dinlenme", level: "B2" },
  { en: "Level", tr: "Düzleştirmek, yıkmak", level: "B2" },
  { en: "Licence", tr: "Lisans", level: "B2" },
  { en: "Limited", tr: "Sınırlı", level: "B2" },
  { en: "Line", tr: "Bir hizada olmak", level: "B2" },
  { en: "Lively", tr: "Canlı, ateşli", level: "B2" },
  { en: "Load", tr: "Yük, yüklemek, doldurmak", level: "B2" },
  { en: "Loan", tr: "Borç", level: "B2" },
  { en: "Logical", tr: "Mantıklı", level: "B2" },
  { en: "Long-term", tr: "Uzun dönem", level: "B2" },
  { en: "Loose", tr: "Gevşek", level: "B2" },
  { en: "Lord", tr: "Lort", level: "B2" },
  { en: "Low", tr: "Alçak, aşağıda", level: "B2" },
  { en: "Lower", tr: "İndirmek, azaltmak", level: "B2" },
  { en: "Lung", tr: "Akciğer", level: "B2" },
  { en: "Maintain", tr: "Sürdürmek", level: "B2" },
  { en: "Majority", tr: "Çoğunluk", level: "B2" },
  { en: "Make", tr: "Üretici firma adı", level: "B2" },
  { en: "Map", tr: "Haritasını yapmak", level: "B2" },
  { en: "Mass", tr: "Yığın, toplu, kitle", level: "B2" },
  { en: "Massive", tr: "Muazzam, iri, çok büyük", level: "B2" },
  { en: "Master", tr: "Efendi, sahip, usta", level: "B2" },
  { en: "Matching", tr: "Uygun, uyumlu olan", level: "B2" },
  { en: "Material", tr: "Materyal", level: "B2" },
  { en: "Maximum", tr: "Maksimum", level: "B2" },
  { en: "Means", tr: "Vasıta, yol, araç, para", level: "B2" },
  { en: "Measurement", tr: "Ölçme, ölçüm", level: "B2" },
  { en: "Medium", tr: "Orta, vasat", level: "B2" },
  { en: "Melt", tr: "Erimek", level: "B2" },
  { en: "Military", tr: "Askeri", level: "B2" },
  { en: "Mineral", tr: "Mineral", level: "B2" },
  { en: "Minimum", tr: "Minimum", level: "B2" },
  { en: "Minister", tr: "Bakan", level: "B2" },
  { en: "Minor", tr: "Önemsiz, basit", level: "B2" },
  { en: "Minority", tr: "Azınlık", level: "B2" },
  { en: "Mission", tr: "Misyon", level: "B2" },
  { en: "Mistake", tr: "Yanlış anlamak, yanılmak", level: "B2" },
  { en: "Mixed", tr: "Karışık", level: "B2" },
  { en: "Model", tr: "Mankenlik yapmak", level: "B2" },
  { en: "Modify", tr: "Değişiklik yapmak", level: "B2" },
  { en: "Monitor", tr: "Bilgisayar ekranı, denetlemek", level: "B2" },
  { en: "Moral", tr: "Ahlaki", level: "B2" },
  { en: "Motor", tr: "Motor, arabalarla ilgili", level: "B2" },
  { en: "Mount", tr: "Başlatmak, harekete geçirmek", level: "B2" },
  { en: "Multiple", tr: "Çoklu", level: "B2" },
  { en: "Multiply", tr: "Artırmak, çoğaltmak", level: "B2" },
  { en: "Mysterious", tr: "Gizemli", level: "B2" },
  { en: "Narrow", tr: "Daraltmak, azaltmak, küçültmek", level: "B2" },
  { en: "National", tr: "Ulusal", level: "B2" },
  { en: "Neat", tr: "Düzenli, tertipli", level: "B2" },
  { en: "Negative", tr: "Negatif", level: "B2" },
  { en: "Nerve", tr: "Sinir", level: "B2" },
  { en: "Nevertheless", tr: "Bununla beraber, buna rağmen", level: "B2" },
  { en: "Nightmare", tr: "Kabus", level: "B2" },
  { en: "Notion", tr: "Fikir, idea", level: "B2" },
  { en: "Numerous", tr: "Çok", level: "B2" },
  { en: "Obey", tr: "İtaat etmek", level: "B2" },
  { en: "Object", tr: "Karşı çıkmak", level: "B2" },
  { en: "Objective", tr: "Objektif", level: "B2" },
  { en: "Obligation", tr: "Zorunluluk", level: "B2" },
  { en: "Observation", tr: "İnceleme, gözlem", level: "B2" },
  { en: "Observe", tr: "İncelemek", level: "B2" },
  { en: "Obtain", tr: "Elde etmek", level: "B2" },
  { en: "Occasionally", tr: "Ara sıra", level: "B2" },
  { en: "Offence", tr: "Suç, kabahat", level: "B2" },
  { en: "Offend", tr: "Kırmak, gücendirmek", level: "B2" },
  { en: "Offensive", tr: "Gücendirici", level: "B2" },
  { en: "Official", tr: "Resmi", level: "B2" },
  { en: "Opening", tr: "Açılış", level: "B2" },
  { en: "Operate", tr: "İşlemek, faaliyet göstermek", level: "B2" },
  { en: "Opponent", tr: "Rakip, muhalif", level: "B2" },
  { en: "Oppose", tr: "Karşı çıkmak", level: "B2" },
  { en: "Opposed", tr: "Karşıt", level: "B2" },
  { en: "Opposition", tr: "Aykırılık, muhalefet", level: "B2" },
  { en: "Organ", tr: "Organ", level: "B2" },
  { en: "Origin", tr: "Kaynak, köken", level: "B2" },
  { en: "Otherwise", tr: "Yoksa, …nın dışında", level: "B2" },
  { en: "Outcome", tr: "Sonuç, netice", level: "B2" },
  { en: "Outer", tr: "Dış, dıştaki", level: "B2" },
  { en: "Outline", tr: "Ana hatlar, açıklamak", level: "B2" },
  { en: "Overall", tr: "Tümü, hepsi, tamamı", level: "B2" },
  { en: "Owe", tr: "Borçlu olmak", level: "B2" },
  { en: "Pace", tr: "Hız, sürat, adım", level: "B2" },
  { en: "Package", tr: "Paketlemek", level: "B2" },
  { en: "Panel", tr: "Panel", level: "B2" },
  { en: "Parliament", tr: "Parlamento", level: "B2" },
  { en: "Participant", tr: "Katılımcı", level: "B2" },
  { en: "Partly", tr: "Kısmen, sınırlı olarak", level: "B2" },
  { en: "Passage", tr: "Pasaj", level: "B2" },
  { en: "Patient", tr: "Sabırlı, tahammüllü", level: "B2" },
  { en: "Permanent", tr: "Kalıcı", level: "B2" },
  { en: "Permit", tr: "İzin vermek, izin", level: "B2" },
  { en: "Perspective", tr: "Perspektif", level: "B2" },
  { en: "Phase", tr: "Evre, aşama", level: "B2" },
  { en: "Phenomenon", tr: "Fenomen", level: "B2" },
  { en: "Philosophy", tr: "Felsefe", level: "B2" },
  { en: "Pick", tr: "Kazma", level: "B2" },
  { en: "Picture", tr: "Düşünmek, resmini yapmak", level: "B2" },
  { en: "Pile", tr: "Yığın, küme, yığmak", level: "B2" },
  { en: "Pitch", tr: "Spor sahası", level: "B2" },
  { en: "Plain", tr: "Sade, basit", level: "B2" },
  { en: "Plot", tr: "Haince plan yapmak, haritada göstermek", level: "B2" },
  { en: "Pointed", tr: "Sivri", level: "B2" },
  { en: "Popularity", tr: "Popülerlik", level: "B2" },
  { en: "Pose", tr: "Sorun çıkarmak, poz vermek", level: "B2" },
  { en: "Position", tr: "Pozisyon", level: "B2" },
  { en: "Positive", tr: "Pozitif", level: "B2" },
  { en: "Possess", tr: "Sahip olmak", level: "B2" },
  { en: "Potential", tr: "Potansiyel", level: "B2" },
  { en: "Power", tr: "Enerji vermek, çalıştırmak", level: "B2" },
  { en: "Praise", tr: "Övmek, methiyeler düzmek", level: "B2" },
  { en: "Pregnant", tr: "Hamile", level: "B2" },
  { en: "Preparation", tr: "Hazırlık", level: "B2" },
  { en: "Presence", tr: "Varlık, bulunma", level: "B2" },
  { en: "Preserve", tr: "Korumak, muhafaza etmek", level: "B2" },
  { en: "Price", tr: "Fiyatlandırmak", level: "B2" },
  { en: "Prime", tr: "Asıl, esas, baş", level: "B2" },
  { en: "Principle", tr: "Prensip", level: "B2" },
  { en: "Print", tr: "Baskı", level: "B2" },
  { en: "Priority", tr: "Öncelik", level: "B2" },
  { en: "Privacy", tr: "Gizlilik", level: "B2" },
  { en: "Procedure", tr: "Prosedür", level: "B2" },
  { en: "Process", tr: "İşlemek", level: "B2" },
  { en: "Produce", tr: "Üretmek", level: "B2" },
  { en: "Professional", tr: "Profesyonel", level: "B2" },
  { en: "Progress", tr: "İlerlemek", level: "B2" },
  { en: "Project", tr: "Tasarlamak, görüntüyü duvara yansıtmak", level: "B2" },
  { en: "Proof", tr: "Kanıt", level: "B2" },
  { en: "Proposal", tr: "Öneri", level: "B2" },
  { en: "Propose", tr: "Önermek", level: "B2" },
  { en: "Prospect", tr: "Olasılık, ihtimal", level: "B2" },
  { en: "Protection", tr: "Koruma", level: "B2" },
  { en: "Psychologist", tr: "Psikolog", level: "B2" },
  { en: "Psychology", tr: "Psikoloji", level: "B2" },
  { en: "Publication", tr: "Yayım", level: "B2" },
  { en: "Pupil", tr: "Öğrenci", level: "B2" },
  { en: "Purchase", tr: "Satın almak", level: "B2" },
  { en: "Pure", tr: "Saf", level: "B2" },
  { en: "Pursue", tr: "Kovalamak", level: "B2" },
  { en: "Range", tr: "Sıraya koymak, arasında değişmek", level: "B2" },
  { en: "Rank", tr: "Rütbe, mevki", level: "B2" },
  { en: "Rapid", tr: "Hızlı, süratli", level: "B2" },
  { en: "Rapidly", tr: "Hızlı bir şekilde", level: "B2" },
  { en: "Rate", tr: "Oran", level: "B2" },
  { en: "Raw", tr: "Çiğ, ham", level: "B2" },
  { en: "Reach", tr: "Mesafe, uzantı", level: "B2" },
  { en: "Realistic", tr: "Realist", level: "B2" },
  { en: "Reasonable", tr: "Mantıklı", level: "B2" },
  { en: "Recall", tr: "Hatırlamak, geri çağırmak", level: "B2" },
  { en: "Recover", tr: "İyileşmek", level: "B2" },
  { en: "Reduction", tr: "Azaltma, indirim", level: "B2" },
  { en: "Regard", tr: "Olarak kabul etmek, saygı", level: "B2" },
  { en: "Regional", tr: "Bölgesel", level: "B2" },
  { en: "Register", tr: "Kaydetmek, kütük", level: "B2" },
  { en: "Regret", tr: "Pişman olmak, üzülmek", level: "B2" },
  { en: "Regulation", tr: "Tüzük, yönetmelik", level: "B2" },
  { en: "Relatively", tr: "Nispeten, göreli olarak", level: "B2" },
  { en: "Relevant", tr: "Konuyla ilgili", level: "B2" },
  { en: "Relief", tr: "Rahatlama, ferahlama", level: "B2" },
  { en: "Rely", tr: "Güvenmek, dayanmak", level: "B2" },
  { en: "Remark", tr: "Söz, laf, demek", level: "B2" },
  { en: "Representative", tr: "Temsilci, delege", level: "B2" },
  { en: "Reputation", tr: "Ün, şöhret", level: "B2" },
  { en: "Requirement", tr: "Gereklilik, koşul", level: "B2" },
  { en: "Rescue", tr: "Kurtarmak", level: "B2" },
  { en: "Reserve", tr: "Yedek, ayırmak", level: "B2" },
  { en: "Resident", tr: "Sakin, oturan", level: "B2" },
  { en: "Resist", tr: "Direnmek, karşı koymak", level: "B2" },
  { en: "Resolve", tr: "Kesin karar vermek", level: "B2" },
  { en: "Resort", tr: "Tatil yeri", level: "B2" },
  { en: "Retain", tr: "Sürdürmek, alıkoymak", level: "B2" },
  { en: "Reveal", tr: "Meydana çıkarmak", level: "B2" },
  { en: "Revolution", tr: "Devrim", level: "B2" },
  { en: "Reward", tr: "Ödül, ödüllendirmek", level: "B2" },
  { en: "Rhythm", tr: "Ritim", level: "B2" },
  { en: "Rid", tr: "Kurtulmak, son vermek", level: "B2" },
  { en: "Root", tr: "Kök", level: "B2" },
  { en: "Round", tr: "Yuvarlak", level: "B2" },
  { en: "Routine", tr: "Rutin", level: "B2" },
  { en: "Rub", tr: "Sürtmek, ovmak", level: "B2" },
  { en: "Rubber", tr: "Kauçuk, lastik", level: "B2" },
  { en: "Rural", tr: "Kırsal", level: "B2" },
  { en: "Rush", tr: "Telaş, acele etmek", level: "B2" },
  { en: "Sample", tr: "Örnek", level: "B2" },
  { en: "Satellite", tr: "Uydu", level: "B2" },
  { en: "Satisfied", tr: "Memnun", level: "B2" },
  { en: "Satisfy", tr: "Tatmin etmek", level: "B2" },
  { en: "Saving", tr: "Tasarruf, birikim", level: "B2" },
  { en: "Scale", tr: "Tartar, ölçek", level: "B2" },
  { en: "Schedule", tr: "Planlamak, tasarlamak", level: "B2" },
  { en: "Scheme", tr: "Tasarı, proje", level: "B2" },
  { en: "Scream", tr: "Çığlık, çığlık atmak", level: "B2" },
  { en: "Screen", tr: "Teşhis etmek, televizyonda göstermek", level: "B2" },
  { en: "Sector", tr: "Sektör", level: "B2" },
  { en: "Secure", tr: "Sağlamlaştırmak, güvenceli", level: "B2" },
  { en: "Seek", tr: "Aramak", level: "B2" },
  { en: "Select", tr: "Seçmek", level: "B2" },
  { en: "Selection", tr: "Seçme", level: "B2" },
  { en: "Self", tr: "Kendi", level: "B2" },
  { en: "Senior", tr: "Kıdemli", level: "B2" },
  { en: "Sense", tr: "Algılamak, hissetmek", level: "B2" },
  { en: "Sensitive", tr: "Duyarlı, hassas", level: "B2" },
  { en: "Sentence", tr: "Mahkum etmek, ceza vermek", level: "B2" },
  { en: "Sequence", tr: "Dizi, zincir", level: "B2" },
  { en: "Session", tr: "Dönem, oturum", level: "B2" },
  { en: "Settle", tr: "Yerleşmek", level: "B2" },
  { en: "Severe", tr: "Çok kötü, sert, katı", level: "B2" },
  { en: "Shade", tr: "Gölge, renk tonu", level: "B2" },
  { en: "Shadow", tr: "Gölge, loşluk", level: "B2" },
  { en: "Shallow", tr: "Sığ, yüzeysel", level: "B2" },
  { en: "Shame", tr: "Utanç", level: "B2" },
  { en: "Shape", tr: "Biçim vermek", level: "B2" },
  { en: "Shelter", tr: "Sığınak, korunak, sığınmak", level: "B2" },
  { en: "Shift", tr: "Değiştirmek, vardiya", level: "B2" },
  { en: "Ship", tr: "Göndermek, sevk etmek", level: "B2" },
  { en: "Shock", tr: "Şok, şok etmek", level: "B2" },
  { en: "Shocked", tr: "Şok olmuş", level: "B2" },
  { en: "Shot", tr: "Atış, vuruş, resim", level: "B2" },
  { en: "Significant", tr: "Önemli, değerli", level: "B2" },
  { en: "Significantly", tr: "Önemli derecede", level: "B2" },
  { en: "Silence", tr: "Sessizlik", level: "B2" },
  { en: "Silk", tr: "İpek", level: "B2" },
  { en: "Sincere", tr: "Samimi, içten", level: "B2" },
  { en: "Slave", tr: "Köle", level: "B2" },
  { en: "Slide", tr: "Kaydırmak, kaymak, slayt", level: "B2" },
  { en: "Slight", tr: "Ufak, az, hafif", level: "B2" },
  { en: "Slip", tr: "Kaymak, sürçmek", level: "B2" },
  { en: "Slope", tr: "Bayır, yokuş", level: "B2" },
  { en: "Solar", tr: "Güneş", level: "B2" },
  { en: "Somewhat", tr: "Birazcık", level: "B2" },
  { en: "Soul", tr: "Ruh", level: "B2" },
  { en: "Specialist", tr: "Uzman", level: "B2" },
  { en: "Species", tr: "Tür", level: "B2" },
  { en: "Speed", tr: "Hız yapmak", level: "B2" },
  { en: "Spiritual", tr: "Ruhani", level: "B2" },
  { en: "Split", tr: "Bölünmek, parçalanmak", level: "B2" },
  { en: "Sponsor", tr: "Desteklemek, finanse etmek", level: "B2" },
  { en: "Spot", tr: "Görmek, ayırt etmek", level: "B2" },
  { en: "Spread", tr: "Yayılma, dağılma, ezme", level: "B2" },
  { en: "Stable", tr: "Stabil", level: "B2" },
  { en: "Stage", tr: "Sahnelemek, hazırlamak", level: "B2" },
  { en: "Stand", tr: "Tezgah, tribün, sehpa", level: "B2" },
  { en: "Stare", tr: "Dik dik bakmak", level: "B2" },
  { en: "Status", tr: "Statü, konum", level: "B2" },
  { en: "Steady", tr: "Devamlı, sürekli", level: "B2" },
  { en: "Steel", tr: "Çelik", level: "B2" },
  { en: "Steep", tr: "Dik, sarp", level: "B2" },
  { en: "Step", tr: "Yürümek", level: "B2" },
  { en: "Sticky", tr: "Yapış yapış", level: "B2" },
  { en: "Stiff", tr: "Sert, katı", level: "B2" },
  { en: "Stock", tr: "Stok", level: "B2" },
  { en: "Stream", tr: "Çay, dere, akıntı", level: "B2" },
  { en: "Stretch", tr: "Uzanmak, yayılmak", level: "B2" },
  { en: "Strict", tr: "Sert, katı", level: "B2" },
  { en: "Strike", tr: "Vurmak, grev yapmak, saldırmak", level: "B2" },
  { en: "Structure", tr: "İtinalı bir şekilde düzenlemek", level: "B2" },
  { en: "Struggle", tr: "Çaba sarf etmek, mücadele", level: "B2" },
  { en: "Stuff", tr: "Tıkmak, tıka basa doldurmak", level: "B2" },
  { en: "Subject", tr: "Bağımlı", level: "B2" },
  { en: "Submit", tr: "Sunmak, arz etmek", level: "B2" },
  { en: "Sum", tr: "Toplam, tutar", level: "B2" },
  { en: "Surgery", tr: "Ameliyat", level: "B2" },
  { en: "Surround", tr: "Kuşatmak", level: "B2" },
  { en: "Surrounding", tr: "Çevre, kuşatma", level: "B2" },
  { en: "Survey", tr: "Araştırmak", level: "B2" },
  { en: "Suspect", tr: "Şüphelenmek, kuşkulanmak", level: "B2" },
  { en: "Swear", tr: "Küfretmek, yemin etmek", level: "B2" },
  { en: "Sweep", tr: "Süpürmek", level: "B2" },
  { en: "Switch", tr: "Değişme, anahtar", level: "B2" },
  { en: "Sympathy", tr: "Sempati", level: "B2" },
  { en: "Tale", tr: "Masal", level: "B2" },
  { en: "Tank", tr: "Tank", level: "B2" },
  { en: "Target", tr: "Hedeflemek", level: "B2" },
  { en: "Temporary", tr: "Geçici", level: "B2" },
  { en: "Term", tr: "İsimlendirmek", level: "B2" },
  { en: "Therapy", tr: "Terapi", level: "B2" },
  { en: "Threat", tr: "Tehdit", level: "B2" },
  { en: "Threaten", tr: "Tehdit etmek", level: "B2" },
  { en: "Thus", tr: "Böylece, bu nedenle", level: "B2" },
  { en: "Time", tr: "Zamanlamak", level: "B2" },
  { en: "Title", tr: "Başlık atmak", level: "B2" },
  { en: "Tone", tr: "Ton", level: "B2" },
  { en: "Tough", tr: "Zorlu, çetin", level: "B2" },
  { en: "Track", tr: "İzlemek", level: "B2" },
  { en: "Transfer", tr: "Transfer, nakletmek", level: "B2" },
  { en: "Transform", tr: "Dönüşmek, dönüştürmek", level: "B2" },
  { en: "Transition", tr: "Geçiş", level: "B2" },
  { en: "Trial", tr: "Duruşma, yargılama", level: "B2" },
  { en: "Trip", tr: "Tökezlemek, takılmak", level: "B2" },
  { en: "Tropical", tr: "Tropikal", level: "B2" },
  { en: "Trouble", tr: "Canını sıkmak, sıkıntı vermek", level: "B2" },
  { en: "Truly", tr: "Tamamen, sahiden", level: "B2" },
  { en: "Trust", tr: "Güven, inanç", level: "B2" },
  { en: "Try", tr: "Girişme, teşebbüs", level: "B2" },
  { en: "Tune", tr: "Name, ezgi", level: "B2" },
  { en: "Tunnel", tr: "Tünel", level: "B2" },
  { en: "Ultimately", tr: "Eninde sonunda", level: "B2" },
  { en: "Unconscious", tr: "Bilinçsiz, şuursuz", level: "B2" },
  { en: "Unexpected", tr: "Beklenmeyen", level: "B2" },
  { en: "Upper", tr: "Üst, yukarı", level: "B2" },
  { en: "Upwards", tr: "Yukarıya, daha fazla", level: "B2" },
  { en: "Urban", tr: "Şehirsel, kentsel", level: "B2" },
  { en: "Urge", tr: "Teşvik etmek, dürtmek", level: "B2" },
  { en: "Value", tr: "Değerli olmak, değer vermek", level: "B2" },
  { en: "Vary", tr: "Çeşitlenmek", level: "B2" },
  { en: "Vast", tr: "Geniş", level: "B2" },
  { en: "Venue", tr: "Olayın gerçekleştiği yer", level: "B2" },
  { en: "Via", tr: "Aracılığıyla", level: "B2" },
  { en: "Victory", tr: "Zafer", level: "B2" },
  { en: "Violence", tr: "Şiddet", level: "B2" },
  { en: "Virtual", tr: "Sanal", level: "B2" },
  { en: "Vision", tr: "Görme", level: "B2" },
  { en: "Visual", tr: "Görsel", level: "B2" },
  { en: "Vital", tr: "Hayati", level: "B2" },
  { en: "Vitamin", tr: "Vitamin", level: "B2" },
  { en: "Volume", tr: "Hacim, cilt, sayı", level: "B2" },
  { en: "Wage", tr: "Maaş, ücret", level: "B2" },
  { en: "Way", tr: "Çok, aşırı, fazla", level: "B2" },
  { en: "Weakness", tr: "Zayıflık", level: "B2" },
  { en: "Wealth", tr: "Zenginlik", level: "B2" },
  { en: "Wealthy", tr: "Zengin", level: "B2" },
  { en: "Whereas", tr: "Oysa, halbuki", level: "B2" },
  { en: "Wherever", tr: "Her nereye, her nerede", level: "B2" },
  { en: "Whisper", tr: "Fısıltı, fısıldamak", level: "B2" },
  { en: "Whom", tr: "Kime, kim", level: "B2" },
  { en: "Widely", tr: "Genişçe", level: "B2" },
  { en: "Wildlife", tr: "Vahşi hayat", level: "B2" },
  { en: "Willing", tr: "İstekli, hevesli", level: "B2" },
  { en: "Wind", tr: "Nefesini kesmek", level: "B2" },
  { en: "Wire", tr: "Tel, kablo", level: "B2" },
  { en: "Wise", tr: "Akıllı", level: "B2" },
  { en: "Witness", tr: "Tanış, şahit, şahit olmak", level: "B2" },
  { en: "Wound", tr: "Yara, yaralamak", level: "B2" },
  { en: "Wrap", tr: "Sarmak", level: "B2" },
  { en: "Zone", tr: "Kuşak, bölge", level: "B2" },
];
